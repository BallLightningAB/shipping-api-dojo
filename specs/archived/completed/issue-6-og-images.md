...
Date: 2026-03-17
Issue: [#6](https://github.com/BallLightningAB/shipping-api-dojo/issues/6)
Scope: Replace leftover Ball Lightning OG assets with Shipping API Dojo branded images and wire them into route metadata.
...
- Social preview validation was completed on 2026-03-18.
- Issue #6 is complete locally and remains closed on GitHub.
